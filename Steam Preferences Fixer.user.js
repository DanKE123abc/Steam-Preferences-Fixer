...
(function() {
    ...
    span1.innerHTML = '主要展示裸露画面或色情主题的游戏或内容。勾选此复选框即表示您确认自己已至少年满18周岁。<br><a href="#">** 国区隐藏选项 勾选后不显示已勾选**</a>';
    ...
    span2.innerHTML = '包含仅针对成人受众的性意味明显或露骨的游戏或内容。勾选此复选框即表示您确认自己已至少年满18周岁。<br><a href="#">** 国区隐藏选项 勾选后不显示已勾选**</a>';
